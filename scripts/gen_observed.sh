...
python data_gen/env.py --env-id WShapesRL-Observed-0shot-$num_obj-$cmap-v0 --fname data/wshapes_observed_$num_obj"_"$cmap"_0shot.h5"  --num-episodes 10000 --episode-length 10 --seed 7
