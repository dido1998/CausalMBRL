...
then
	...
	--epochs 0 --finetune-epochs 100 --predict-diff  --contrastive | tee -a "$save_folder_/train.log"
	...
	--valid-dataset $dataset3 \
	--save-folder $save_folder_ --batch-size 32 --seed 1 \
	--epochs 0 --finetune-epochs 100 --predict-diff  | tee -a "$save_folder_/train.log"
