...
max_steps=$5
movement=$6
save_folder=scoff-$num_obj-$num_colors-$max_steps-$movement-$seed-$contrastive_loss
truth=True
...
then
	...
	python train_recurrent.py --dataset data/ColorChangingRL_$num_obj-$num_colors-$max_steps-$movement-train-$seed.h5 \
